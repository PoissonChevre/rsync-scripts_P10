...
# Find the most recent backup (using mtime for directory change time), create less than 1680 minutes (28 heures)
is_last_backup() {
    LAST_BACKUP=$(ssh $REMOTE "find $DST_DIR -maxdepth 1 -name 'backup_*' -cmin -1680 | sort | tail -n 1 ")
